...
public class ShowcaseView extends RelativeLayout
    ...
    public void setDrawInnerCircle(boolean b)
    {
        ...
        if (showcaseDrawer != null) {
            showcaseDrawer.setDrawInnerCircle(b);
        }
    }
    ...
    public void setDrawRect(boolean b)
    {
        drawRect = b;
        if (showcaseDrawer != null)
            showcaseDrawer.setDrawRect(b);
    }

    public void restoreRadius()
    {
        setAllRadius((int) getResources().getDimension(R.dimen.showcase_radius), (int) getResources().getDimension(R.dimen.showcase_radius_inner),
                (int) getResources().getDimension(R.dimen.showcase_radius_outer));
    }
    ...
    @Override
    public void setContentTitle(CharSequence title) { textDrawer.setContentTitle(title); }
